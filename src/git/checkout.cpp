...
namespace yaga_git
{
    checkout_progress_status::checkout_progress_status(
        const char* raw_path,
    ...
    checkout_notify_status::checkout_notify_status(
        git_checkout_notify_t why_raw,
        const char* path_raw,
    ...
    checkout_notification_type operator|(checkout_notification_type a, checkout_notification_type b)
    {
        ...
        return static_cast<checkout_notification_type>(
