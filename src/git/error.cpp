...
namespace yaga_git
{
    ...
    namespace detail
    {
        ...
        {
            switch (static_cast<yaga_git::error_code>(c))
            {
                case error_code::ok:
                    return "Success";
...
const yaga_git::detail::error_code_category& git_error_code_category()
{
    static yaga_git::detail::error_code_category c;
    return c;
}

std::error_code make_error_code(yaga_git::error_code e)
{
    return {static_cast<int>(e), git_error_code_category()};
}

std::error_code make_error_code(yaga_git::error e)
{
